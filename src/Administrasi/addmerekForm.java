 ...
 * @author Cheria
 */
public class addmerekForm extends javax.swing.JFrame {
    int j = 0;
    Connection con;
    Statement st;
    ResultSet rs;
    ...
    public void connect() {
        try {
            ...
            st = con.createStatement();
                       rs = st.executeQuery("select MAX(ID_merek) from tblmerek");

            while(rs.next()) {
        String idmerlengkap = rs.getString(1);
        
        if(idmerlengkap == null){
            idmerek= String.format("%04d", 1);
            lblmer.setText("MER-"+idmerek);
        }
        else{
        String[] idjeninc = idmerlengkap.split("-");
        int idmer2 = Integer.parseInt(idjeninc[1]);
        idmer2 = idmer2+1;
        idmerek= String.format("%04d", idmer2);
                    lblmer.setText("MER-"+idmerek);
        }
            }
        }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ID Merek");

        lblmer.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblmer, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addGap(64, 64, 64))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel3)
                    .addComponent(lblmer, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        try {
            ...
            String sql = "Insert into tblmerek values('MER-"+idmerek+"','"+merek+"')";
    ...
    private javax.swing.JLabel lblmer;
