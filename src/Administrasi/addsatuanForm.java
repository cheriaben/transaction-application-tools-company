 ...
 * @author Cheria
 */
public class addsatuanForm extends javax.swing.JFrame {
     ...
     */
    public addsatuanForm() {
        initComponents();
        setLocationRelativeTo(null);
        setVisible(true);
        setTitle("Tambah Satuan Barang");
        bersih(); 
        connect();
    ...
    public void connect() {
        try {
            ...
            rs = st.executeQuery("select MAX(ID_satuan) from tblsatuan");
                        while(rs.next()) {
        String idsatlengkap = rs.getString(1);
        
        if(idsatlengkap == null){
            idsatuan= String.format("%04d", 1);
            lblsat.setText("SAT-"+idsatuan);
        }
        else{
        String[] idjeninc = idsatlengkap.split("-");
        int idsat2 = Integer.parseInt(idjeninc[1]);
        idsat2 = idsat2+1;
        idsatuan= String.format("%04d", idsat2);
                    lblsat.setText("SAT-"+idsatuan);
        }
            }
        }
    ...
    private void initComponents() {
        ...
        lblsat.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel3)
                    .addComponent(lblsat, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        try {
            ...
            String sql = "Insert into tblsatuan values('SAT-"+idsatuan+"','"+satuan+"')";
